        ...
        <SidebarInset>
          <div className="sticky top-0 z-50 flex h-16 w-full items-center justify-between border-b bg-background px-4">
            <div className="flex items-center gap-2">
              ...
              <Input placeholder="Search dashboard..." className="w-[250px] md:w-[400px]" data-testid="search-input" />
            </div>
          ...
          <div className="flex flex-1 flex-col p-6">
            <div className="@container/main flex flex-1 flex-col gap-4">
              ...
              <div className="px-4 lg:px-6">
                ...
                {showStats ? <ChartAreaInteractive /> : <p data-testid="no-stats">Stats are hidden</p>}
              </div>
            </div>
            <DataTable data={data} />
            <CalendarModal />
